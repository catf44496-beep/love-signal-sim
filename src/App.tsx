...
const SCENARIOS: StoryScenario[] = [
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'opt-shen-ep2', label: '猜测叶闻笙 (关键词：倾听)', target: '叶闻笙', desc: '他展示了一张心理测评表，指尖修长干净。', intro: "\"倾听...是心理医生吗？\"你轻声问道。叶闻笙摘下眼镜，露出那双好看的瑞凤眼。", story_result: "\"是心理医生。\"他用纸巾慢条斯理地擦拭镜片，动作优雅得像电影慢镜头。\n\n\"我习惯分析他人的情绪，但最近...\"他抬眼看你，嘴角勾起极淡的弧度，\"我发现有些心动，是无法用专业术语解释的。\"", avatar: CHARACTERS[1].avatarImage, cg_title: "专业心动 · 无法解释" },
