...
const CHARACTERS: Character[] = [
  {
    ...
    avatarImage: '/images/guyichen.png',
    stats: { heartbeat: 10, jealousy: 0, syncRate: 15, mood: "觀察", trait: "理性·光", cpRate: 50 },
    impression: "气质独特。",
    tags: ["理性", "成熟", "谨慎"],
    profile: {
      surface: "理性冷静，看惯了婚姻的阴暗面却依然相信真爱。外表冷淡疏离，实则内心细腻敏感，害怕受伤所以习惯用冷漠保护自己。离婚律师，晨曦律师事务所，专攻婚姻家事法。来自上海，身高185cm。",
      inner: "处理太多离婚案件，开始怀疑婚姻和爱情。朋友说'你需要亲身体验一次真正的感情'，半推半就来参加节目。父母在他10岁时离婚，过程极其痛苦。这让他立志成为律师，希望帮人体面地结束错误的婚姻，但也因此对婚姻产生了深深的不信任。胜诉率95%，被称为'铁面律师'，但很少有人知道，他会偷偷资助离婚案中受伤害的孩子。",
      hobbies: ["黑咖啡", "古典音乐", "深夜阅读法律书籍", "独自散步"]
    }
  },
  {
    id: 'shen', name: '温予安', age: 29, job: '省重点高中班主任 / 语文名师',
    ...
    stats: { heartbeat: 15, jealousy: 0, syncRate: 20, mood: "表演中", trait: "伪装者·冰", cpRate: 45 },
    impression: "温柔得不像真人...",
    tags: ["道德洁癖", "表演型人格", "伪装者"],
    profile: {
      surface: "省重点高中班主任，语文名师。长期处于被学生、家长、校领导监视的高压环境下，活成了'完人'。他的温柔是职业训练的结果，在节目中永远在收拾残局、照顾大家情绪，但眼底一片冰凉。",
      inner: "内心深处有极其阴暗、暴戾的破坏欲。用完美的演技欺骗所有人，唯独骗不过画家的眼睛。他是伪装者，用道德洁癖和表演型人格掩盖真实的自己。",
      hobbies: ["阅读文学经典", "深夜批改作业", "独自思考"]
    }
  },
  {
...
const SCENARIOS: StoryScenario[] = [
  {
    ...
    options: [
      { id: 'opt-lu-ep1', label: '回应顾易臣的注视', target: '顾易臣', desc: '他的目光冷静而礼貌，带着职业性的审视，让人看不透在想什么。', intro: "【恋爱小屋 - 入住日】\n\n节目组的车停在别墅门口，你提着行李走下车。\n\n客厅里已经坐着一个穿着灰色针织衫的男人，正专注地看着手中的文件。\n\n听到脚步声，他抬起头，眼神锐利而审视，像在法庭上看待对方律师一样。", story_result: "\"你好，我是顾易臣，律师。\"他简洁地自我介绍，语气公事公办。\n\n【弹幕：这个男生看起来好严肃啊！完全不像来谈恋爱的！】\n\n你选择热情地打招呼，他微微一愣，似乎对你的热情有些不适应，微微皱眉。\n\n\"嗯。\"他点了点头，然后又低头看文件。\n\n气氛有些尴尬。几秒钟后，他像是意识到自己太冷淡，抬起头：\"需要帮忙吗？\"\n\n【弹幕：易臣这反应...社恐实锤了！但好想看他破防的样子！】\n\n你请他帮忙拿箱子，他放下文件，走过来接过你的箱子。\n\n\"挺重的。\"他评价道，然后轻松地提起来，\"走吧。\"\n\n上楼梯时，他保持着礼貌的距离，一言不发。到了房间门口，他放下箱子：\"有事可以找我，我在对面。\"\n\n转身要走时，他停顿了一下：\"对了，晚餐我负责。有忌口吗？\"\n\n【弹幕：易臣好贴心！虽然话少但都是实际行动！】\n\n你好奇他还会做饭，他平静地说：\"处理离婚案件时学的。很多当事人情绪失控，连饭都吃不下。我会做点简单的食物。后来就习惯了。\"\n\n他的语气很淡，但你能感受到藏在字里行间的温柔。\n\n【弹幕：天哪！易臣这个理由...太戳了！表面冷酷内心温暖！】\n\n唐婉端着酒杯，若有所思：\"这律师，滴水不漏。但...似乎也有柔软的一面。\"", avatar: '/images/guyichen.png', cg_title: "职业礼节 · 滴水不漏" },
      { id: 'opt-shen-ep1', label: '对温予安点头致意', target: '温予安', desc: '他站在角落里，金丝眼镜后的眼神带着职业性的观察，保持着安全距离。', intro: "温予安推了推眼镜，目光在每个新来的人身上都会停留几秒，像是职业习惯。", story_result: "他没有主动上前，只是在你走近时礼貌地点了点头。\n\n\"小心，门槛有点高。\"\n\n声音清冷，说完便收回了视线，继续翻看手中的书。他对所有人都保持着同样的距离——不冷漠，但也不热络。\n\n你注意到他的目光会时不时扫过客厅里的每个人，像是在默默观察着什么。\n\n苏小小小声说：\"温老师好安静啊，不知道在想什么...\"", avatar: CHARACTERS[1].avatarImage, cg_title: "习惯观察 · 安全距离" },
  ...
  {
    id: 'ep2', phase: '第2期', episodeTitle: '社交协议', slogan: "职业病大爆发 · 用工作的方式谈恋爱", rarity: "R",
    coverImage: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?q=80&w=2070&auto=format&fit=crop",
    weather: '晴 28℃', location: '废墟小屋', task: '废墟拓荒',
    directorMission: "分组改造破败的红砖小屋，在劳动中观察彼此的职业本能与真实性格。",
    text: `节目组把你们带到了一个废弃的红砖小屋前。\n\n破败的墙壁、生锈的铁窗、杂草丛生的院子——这是一场真正的"废墟拓荒"。\n\n当职业本能撞上废墟改造，是谁在建设，是谁在偷懒，又是谁在动心？\n\n我们都在用工作的方式谈恋爱。`,
    options: [
      { id: 'opt-lu-ep2', label: '与顾易臣组队', target: '顾易臣', desc: '他拿出手机开始拍照取证，像在勘察案发现场。职业病让他把改造当成了一场法律风险评估。', intro: "顾易臣站在破败的小屋前，拿出手机开始拍照。他绕着房子走了一圈，记录下每一处破损，像是在勘察案发现场。", story_result: "\"根据《建筑安全条例》，这面墙需要加固。\"他指着墙上的裂缝，语气专业得像在法庭上陈述证据，\"还有，这个电路系统完全不符合安全标准。\"\n\n你看着他一本正经的样子，忍不住笑了：\"顾律师，我们是来改造，不是来打官司的。\"\n\n他愣了一下，然后也笑了：\"抱歉，职业病。\"他收起手机，看向你，\"不过...和你一起改造，我愿意承担所有风险。\"\n\n【弹幕：律师的职业病也太可爱了吧！把改造当成案件分析！】", avatar: CHARACTERS[0].avatarImage, cg_title: "风险评估 · 职业病爆发" },
      { id: 'opt-shen-ep2', label: '与温予安组队', target: '温予安', desc: '他拿出笔记本开始制定"改造计划"，像在备课。职业病让他把劳动当成了一堂需要精心设计的课程。', intro: "温予安从包里拿出一个笔记本，开始在上面写写画画。他推了推眼镜，表情认真得像在备课。", story_result: "\"我们需要先制定一个详细的改造计划。\"他翻开笔记本，上面已经画好了房屋结构图，\"第一步，清理杂物；第二步，修补墙面；第三步...\"\n\n你看着他认真的样子，忍不住问：\"温老师，你是在备课吗？\"\n\n他抬起头，金丝眼镜后的眼神温柔：\"不，我是在...和你一起创造未来。\"\n\n【弹幕：温老师把改造当成课程设计！职业病太明显了！】", avatar: CHARACTERS[1].avatarImage, cg_title: "课程设计 · 精心规划" },
      { id: 'opt-jiang-ep2', label: '与江烈组队', target: '江烈', desc: '他看着破败的小屋，眼神发亮，像看到了一个完美的游戏场景。职业病让他把现实当成了可以改造的虚拟世界。', intro: "江烈站在小屋前，眼神发亮。他拿出手机，开始拍摄各种角度，嘴里还念念有词：\"这个场景可以做成...\"", story_result: "\"这个场景可以做成废土风格的背景！\"他兴奋地指着破败的墙壁，\"你看，这些裂缝、这些锈迹，都是完美的细节！\"\n\n你看着他激动的样子，忍不住问：\"江烈，我们是来改造的，不是来取材的。\"\n\n他愣了一下，然后不好意思地挠挠头：\"抱歉，职业病。不过...\"他看向你，眼神突然认真起来，\"和你一起改造，我想把这里变成我们两个人的世界。\"\n\n【弹幕：游戏制作人的职业病！把现实当游戏场景！】", avatar: CHARACTERS[2].avatarImage, cg_title: "场景设计 · 虚拟现实" },
    ]
  },
  {
    ...
    options: [
      { id: 'opt-lu-ep3', label: '前往市图书馆 (顾易臣)', target: '顾易臣', desc: '定位在圖書館珍本區。那裡光線昏暗，只有書香和他身上的冷冽氣息。', intro: "圖書館的角落裡，顧易臣正背對著你整理書架。白襯衫被雨水打濕，隱約透出肌肉線條。", story_result: "你剛走近，就被他一把拉進了書架深處的死角。\n\n\"噓...\"他的手指抵在你的唇上，呼吸滾燙。\n他單手撐在你耳側，將你困在書架與胸膛之間，摘下眼鏡，眼神不再克制：\"這裡沒有攝像頭...林柚，我可以不做那個克制的顧易臣了嗎？\"", avatar: CHARACTERS[0].avatarImage, cg_title: "書架咚 · 禁慾崩壞" },
      { id: 'opt-shen-ep3', label: '前往私人书房 (温予安)', target: '温予安', desc: '那是他從未對外公開的領地。今晚，他想讓你做唯一的訪客。', intro: "書房的門虛掩著，透出暖黃的燈光。你推門而入，卻看到蘇小小正慌張地站在書架前，地上散落著瓷杯的碎片。\n\n那是一隻絕版的青花瓷杯，溫予安最心愛的那隻。\n\n蘇小小眼眶泛紅：\"對不起...我不小心...\"\n\n溫予安蹲下身，開始收拾碎片。他的動作很輕，聲音溫柔得像春風：\"沒關係，碎碎平安，沒扎到手就好。\"\n\n【彈幕：溫老師真的好溫柔啊！這種時候還在關心別人！】\n\n但你注意到了——在他撿起碎片的那一秒，他的拇指指腹狠狠按在了鋒利的瓷片上。鮮血從指縫間滲出，但他臉上的笑容紋絲不動。\n\n【獲得素材卡：帶血的假面】\n\n你看著他，突然明白了什麼。這個男人，每一塊肌肉都在用力維持\"鬆弛\"的假象。", story_result: "蘇小小離開後，書房裡只剩下你們兩個人。\n\n溫予安走到落地窗前，看著窗外的雨幕。他背對著你，但你看到他的肩膀在微微顫抖。\n\n\"你看到了，對吧？\"他突然開口，聲音沙啞，\"你看到了我剛才...那個樣子。\"\n\n你沒有回答，只是走到他身邊。\n\n他轉過身，眼底一片冰涼，但嘴角依然掛著那完美的弧度：\"林柚，你為什麼總是在看我？看我的眼角，看我的指關節，看那些...我拼命想藏起來的東西。\"\n\n\"因為我在畫你。\"你平靜地說，\"畫家需要看到結構，而不是表象。\"\n\n他愣住了。幾秒鐘後，他摘下眼鏡，第一次在你面前露出了真實的表情——那是一種極度恐慌，卻又帶著變態興奮的複雜情緒。\n\n\"終於有人...看到了真實的我。\"他輕聲說，指尖輕輕拂過你的髮絲，\"你在我心裡的比重，已經讓我的世界失衡了。你願意...做我的支點嗎？\"", avatar: CHARACTERS[1].avatarImage, cg_title: "靈魂支點 · 帶血的假面" },
  ...
  },
  {
    ...
    options: [
      { id: 'opt-lu-ep4', label: '顧易臣的紅酒燉牛肉', target: '顾易臣', desc: '他在廚房裡也像是在做實驗，精確而優雅，紅酒的香氣令人沈醉。', intro: "顧易臣挽起袖口，露出線條流暢的小臂。他精準地控制著火候，就像處理法律條文一樣嚴謹。", story_result: "你遞給他調料瓶時，指尖相觸。他低聲說：\"這道菜需要時間慢慢燉，就像我們之間的關係。\"", avatar: CHARACTERS[0].avatarImage, cg_title: "精準投餵" },
      { id: 'opt-shen-ep4', label: '温予安的手沖咖啡', target: '温予安', desc: '午後的陽光和咖啡香氣，是他獨有的溫柔，時間彷彿在他身邊靜止。', intro: "温予安專注地注水，水流在濾紙上畫圈。陽光灑在他側臉，金絲眼鏡邊緣泛著光。", story_result: "他遞給你一杯剛沖好的咖啡：“試試看，這是我為你特調的豆子，帶一點花香和果酸。”", avatar: CHARACTERS[1].avatarImage, cg_title: "午後醇香" },
  ...
  },
  {
    ...
    options: [
      { id: 'opt-lu-ep5', label: '質問顧易臣', target: '顾易臣', desc: '借著酒勁，問出那個一直藏在心裡、不敢問的問題。', intro: "酒瓶指向了顧易臣。你深吸一口氣，決定不再迴避。", story_result: "\"你對我是認真的嗎？\"你直視他的眼睛。他放下酒杯，眼神深邃：\"比我處理過的任何一個案件都認真。\"", avatar: CHARACTERS[0].avatarImage, cg_title: "酒後真言" },
      { id: 'opt-shen-ep5', label: '挑戰温予安', target: '温予安', desc: '讓他摘下那層疏離的面具，露出真實的情緒波動。', intro: "“大冒險，對視十秒。”你提出了挑戰。温予安愣了一下，隨即摘下眼鏡。", story_result: "沒有了鏡片的遮擋，他的眼神溫柔得像一汪湖水。第五秒，他先移開了視線，耳尖微紅：“你贏了。”", avatar: CHARACTERS[1].avatarImage, cg_title: "破冰時刻" },
      { id: 'opt-jiang-ep5', label: '逗弄江烈', target: '江烈', desc: '看他臉紅心跳、手足無措的樣子，是一種別樣的樂趣。', intro: "“真心話，你在這裡最喜歡誰？”江烈的臉瞬間爆紅，支支吾吾。", story_result: "“當然是...當然是大家都喜歡啊！”他看了你一眼，小聲補充，“但最喜歡姐姐。”", avatar: CHARACTERS[2].avatarImage, cg_title: "純情反應" },
      {
        ...
        label: '【支线】十年资产清算',
        target: '顾易臣',
        desc: '深夜的露台，唐婉的委托书。一场关于理智与情感的博弈。',
        intro: "【深夜的委托书】—— 只有利益，没有暧昧\n\n恋综小屋的露台，深夜2点。\n\n顾易臣刚处理完工作，出来透气。发现唐婉一个人坐在那里抽烟（没点火），脚边放着厚厚的一叠文件。",
        story_result: "支线剧情已触发，请查看详细对话。",
        avatar: CHARACTERS[0].avatarImage,
        cg_title: "十年资产清算",
        dialogues: [
          {
            speaker: 'narrator',
          ...
          {
            speaker: '唐婉',
            text: '顾大律师，接私活吗？按你的顶格时薪算，不打折。',
            emotion: 'normal'
          },
          {
            speaker: 'narrator',
            text: '唐婉听到脚步声，没有回头，声音冷静得可怕。'
          },
          {
            speaker: '顾易臣',
            text: '唐总的公关危机？这不归我管。',
          ...
          {
            speaker: '唐婉',
            text: '不是公关，是财产纠纷。我和那个跟了我十年的男人分了。他想要我公司30%的干股，还有我那套在静安的别墅。\n\n我需要你帮我让他——净身出户。',
            emotion: 'normal'
          },
          {
            speaker: 'narrator',
            text: '唐婉把文件推给他，眼神冷静得可怕。'
          },
          {
            speaker: '顾易臣',
            text: '十年感情，你确定要做得这么绝？通常我的当事人都会心软。',
            characterId: 'lu',
            emotion: 'normal'
          },
          {
          ...
          {
            speaker: '唐婉',
            text: '感情归感情，生意归生意。他背叛了我们的"契约"，我就要执行违约条款。顾易臣，在这个屋子里，只有你懂这种逻辑。帮我杀了他（在法律上），算我欠你一个人情。',
            emotion: 'normal'
          },
          {
            speaker: 'narrator',
          ...
          {
            speaker: '顾易臣',
            text: '成交。唐婉，你比我想象的更像我。',
            characterId: 'lu',
            emotion: 'normal'
          },
          {
            speaker: 'narrator',
            text: '顾易臣合上文件，露出职业微笑。\n\n【场景二：博弈与镜像】\n\n几天后，顾易臣的书房（或他在节目组的临时办公点）。\n\n两人正在商讨对策。顾易臣展现了他冷血的一面，提出了几个极其狠毒的方案（查男方税务、冻结资产）。'
          },
          {
            speaker: '顾易臣',
            text: '如果利用他抄袭的丑闻来逼迫对方放弃财产，你会损失五千万。但这是最有效的方法。',
            characterId: 'lu',
            emotion: 'normal'
          },
          {
            speaker: 'narrator',
            text: '当顾易臣建议利用男方的一个隐私丑闻（比如抄袭）来逼迫对方放弃财产时，唐婉犹豫了。'
          },
          {
            speaker: '顾易臣',
            text: '你在心软。唐婉，这不像你。如果不用这张牌，你会损失五千万。',
            characterId: 'lu',
            emotion: 'normal'
          },
          {
          ...
          {
            speaker: '唐婉',
            text: '那毕竟是十年的青春。毁了他的事业，我也不会开心。顾律，这就是我和你的区别。你只看输赢，我还看过去。',
            emotion: 'normal'
          },
          {
            speaker: 'narrator',
            text: '唐婉看着窗外。\n\n顾易臣的心理活动：他看着唐婉。这个女人在商场上杀伐决断，却在面对十年的烂桃花时，依然保留了一丝底线。这让他突然想到了自己——如果有一天他和林柚分开，他能做到像唐婉这样理智吗？还是会像个疯子一样毁掉一切？\n\n唐婉的痛苦让他意识到：理智，有时候是对痛苦的各种掩饰，也是最无用的东西。'
          },
          {
            speaker: 'narrator',
            text: '【场景三：结案与助攻】\n\n案件结束。唐婉赢了（虽然没有让男方身败名裂，但保住了核心资产）。\n\n为了感谢顾易臣，唐婉请他喝一杯。'
          },
          {
            speaker: '唐婉',
            text: '谢谢。这笔律师费花得值。以后你有公关危机，随时找我。',
            emotion: 'normal'
          },
          {
            speaker: 'narrator',
            text: '唐婉晃着酒杯，状态比刚来节目时轻松多了。'
          },
          {
            speaker: '顾易臣',
            text: '客气。不过唐婉，值得吗？十年，最后只换来这一纸判决书。',
            characterId: 'lu',
            emotion: 'normal'
          },
          {
            speaker: 'narrator',
            text: '唐婉转过身，看着远处正在画画的林柚。'
          },
          {
            speaker: '唐婉',
            text: '所以啊，顾易臣，别像我一样。\n\n我花了十年去计算利弊，去权衡这个时候结婚合不合适，去想我和他的资源能不能互换……结果呢？算计到最后，爱没了，只剩钱。',
            emotion: 'normal'
          },
          {
            speaker: 'narrator',
          ...
          {
            speaker: '唐婉',
            text: '你对林柚，也在算计吗？算投入产出比？算风险？\n\n别算了，顾大律师。爱是不可控的变量。遇到那种让你想"甚至不签婚前协议"的人，就抓住她。否则，你这辈子赚再多钱，也就是个孤独的有钱人，像现在的我一样。',
            emotion: 'normal'
          },
          {
            speaker: '顾易臣',
          ...
          {
            speaker: 'narrator',
            text: '顾易臣愣住，目光复杂地看向林柚。\n\n【支线剧情结束】\n\n通过处理唐婉的案子，顾易臣直面了"长期亲密关系破裂"的真相。这让他对林柚的感情从"想占有"转变为"想珍惜"——他不想重蹈唐婉的覆辙。'
          }
        ]
      }
    ]
  },
  {
    ...
    options: [
      { id: 'opt-lu-ep6', label: '顧易臣的煙花秀', target: '顾易臣', desc: '他為你包下了整場煙花表演，只為博你一笑。', intro: "夜幕降臨，城堡上空突然綻放出絢爛的煙花。", story_result: "\"喜歡嗎？\"他站在你身後，為你擋住人群，\"我想讓你知道，在我這裡，你永遠是焦點。\"", avatar: CHARACTERS[0].avatarImage, cg_title: "獨家浪漫" },
      { id: 'opt-shen-ep6', label: '温予安的鬼屋探險', target: '温予安', desc: '在恐懼中，緊緊握住他的手，感受他掌心的溫度。', intro: "鬼屋裡陰森恐怖，你下意識地抓住温予安的衣角。他反手握住你的手。", story_result: "“別怕，跟著我。”他的聲音在黑暗中格外安心。走出鬼屋時，他也沒有鬆開手。", avatar: CHARACTERS[1].avatarImage, cg_title: "吊橋效應" },
  ...
  },
  {
    ...
    options: [
      { id: 'opt-lu-ep7', label: '與顧易臣看日出', target: '顾易臣', desc: '裹著毛毯，並肩等待第一縷陽光灑在海面上。', intro: "凌晨四點，顧易臣叫醒了你。海邊很冷，他把外套披在你身上。", story_result: "太陽升起的那一刻，金光灑滿海面。他轉頭看你，眼裡倒映著朝陽和你：\"早安，我的太陽。\"", avatar: CHARACTERS[0].avatarImage, cg_title: "晨光熹微" },
      { id: 'opt-shen-ep7', label: '與温予安撿貝殼', target: '温予安', desc: '在沙灘上漫步，尋找那顆獨一無二的珍珠。', intro: "温予安低頭專注地在沙灘上尋找著什麼。海浪拍打著他的褲腳。", story_result: "他撿起一枚白色的貝殼，遞給你：“這像不像我們初見那天，你穿的裙子的顏色？”", avatar: CHARACTERS[1].avatarImage, cg_title: "海之信物" },
  ...
  },
  {
    ...
    options: [
      { id: 'opt-lu-ep8', label: '給顧易臣寫信', target: '顾易臣', desc: '紙短情長，用文字寫下你羞於啟齒的心意。', intro: "你坐在書桌前，提筆寫下這段時間的點點滴滴。顧易臣敲響了你的房門。", story_result: "他拿著一封同樣厚實的信：\"看來我們想到一起去了。明天，我在終點等你。\"", avatar: CHARACTERS[0].avatarImage, cg_title: "紙上情書" },
      { id: 'opt-shen-ep8', label: '給温予安留錄音', target: '温予安', desc: '有些話，只想說給他聽，讓他反覆回味。', intro: "你躲在衣帽間，對著錄音筆輕聲訴說。温予安在門外靜靜聽著。", story_result: "推開門，他眼眶微紅：\"林柚，謝謝你願意走進我的世界。這是我聽過最動聽的聲音。\"", avatar: CHARACTERS[1].avatarImage, cg_title: "語音留言" },
  ...
  },
  {
    ...
    options: [
      { id: 'opt-lu-ep9', label: '私人游艇出海 (顾易臣)', target: '顾易臣', desc: '黑金卡片上只寫了一個碼頭坐標。那是遠離塵囂的海上孤島。', intro: "私人遊艇停靠在碼頭，顧易臣站在甲板上向你伸出手。海風吹起他的衣角，他背後是無盡的藍。", story_result: "遊艇駛向大海深處。他從口袋裡拿出一份規劃書——竟然是他為你規劃的未來十年。\n\n\"我不想只爭朝夕，林柚。\"\n海風中，他的聲音堅定而深情，\"我想預定你的未來。這份合約的期限是永久，違約金是我的全部身家。你...敢簽嗎？\"", avatar: CHARACTERS[0].avatarImage, cg_title: "孤島獨處 · 餘生合約" },
      { id: 'opt-shen-ep9', label: '沉浸式光影展 (温予安)', target: '温予安', desc: '一張手繪的門票，通往一座即將閉館的美術館。那是他為你造的夢。', intro: "美術館閉館了，但温予安手裡有鑰匙。他站在光影交錯的展廳中央，等待著帶你走進他的藝術世界。", story_result: "展廳中央，無數光點匯聚成你的模樣。\n\n温予安站在光影中央，向你伸出手：\"藝術追求永恆，但我只追求你。\"\n他牽著你停在一張空白的畫布前，遞給你一支筆：\"我的世界曾是一片灰白，直到你出現。林柚，這剩下的留白，我都交給你來填滿。\"", avatar: CHARACTERS[1].avatarImage, cg_title: "光影交錯 · 唯一繆斯" },
...
const ENDINGS: EndingScenario[] = [
  ...
  // 温予安结局
  { id: 'end_shen_true', charId: 'shen', title: '凝固永恒', keyword: '灵魂缪斯', story: '你是他完美面具下唯一的真实。他在讲台上为你写诗，你用画笔看穿他的伪装。', img: CHARACTERS[1].avatarImage, icon: Sparkle, type: 'True End', buff: '艺术神仙眷侣', requiredHeartbeat: 80 },
...
const EPISODE_SOCIAL_DATA: Record<string, EpisodeSocialData> = {
  'ep1': {
    hotSearches: [
      {
        ...
        detailedPosts: [
          ...
          { id: 'p6', userName: '专业水军', userTag: '', isVip: false, time: '15分钟前', device: 'Android', content: '楼上那位，江烈明显就是装出来的，这种热情太假了。真正有深度的是温予安，你们都不懂。', likes: 12, comments: 89, reposts: 5 },
    ...
    cpRanking: [
      ...
      },
      {
        ...
        observerComment: "温予安比较慢热，但是这种细水长流的感觉也不错。",
        fanComments: ["都在细节里！", "艺术组上分！", "细水长流最浪漫！"],
        relatedCharId: 'shen',
        superTopic: {
          title: "予若", level: "LV1", readCount: "8000万", postCount: "8000",
          posts: [
            { id: 'cp7', userName: '艺术组', userTag: '文艺青年', isVip: true, time: '7分钟前', device: 'iPad', content: '予若这对真的很有艺术感！语文老师和插画师的组合，文艺又浪漫！\n\n#予若# #灵魂伴侣#', likes: 3456, comments: 789, reposts: 234, tags: ['予若'] }
          ]
        }
      }
    ],
    observerDiscussion: [
      { id: 'ob1', author: '楊丞琳', role: '心動偵探', title: '【微表情分析】顧易臣那個眼神！', content: '大家有沒有注意到，林柚剛進來的時候，顧易臣本來在看文件，但他那個眼神停留的時間明顯超過了社交禮儀的安全區！這絕對是有好感！', time: '10分鐘前', replies: 156 },
      ...
      { id: 'ob3', author: '李雪琴', role: '嗑學家', title: '【吐槽】温予安太端著了吧？', content: '沈老師那個“小心台階”也太官方了哈哈哈哈，但是我怎麼覺得這種高嶺之花一旦下神壇會很猛呢？期待打臉！', time: '20分鐘前', replies: 230 }
    ],
    fanDiscussions: [
      { id: 'f1', username: '吃瓜第一線', content: '顧易臣太會了！！那個接行李的動作我反覆看了十遍！', likes: 1205, avatarColor: 'bg-yellow-400' },
      { id: 'f2', username: '蘇蘇的狗', content: '只有我喜歡江烈嗎？小狗多可愛啊！', likes: 892, avatarColor: 'bg-green-400' },
      { id: 'f3', username: '建築美學', content: '温予安的聲音好好聽，低音炮殺我！', likes: 654, avatarColor: 'bg-blue-400' },
      { id: 'f4', username: '路人甲', content: '這一季女嘉賓顏值好高，希望能有個好結局。', likes: 233, avatarColor: 'bg-gray-400' }
    ]
  },
  'ep2': {
    hotSearches: [
      { id: 1, rank: 1, topic: "#顧易臣 律師小說照進現實#", tag: "爆", readCount: "15.5亿", discussCount: "48萬", comments: [], detailedPosts: [] },
      { id: 2, rank: 2, topic: "#江烈 游戏制作人#", tag: "沸", readCount: "9.8亿", discussCount: "25万", comments: [], detailedPosts: [] },
      { id: 3, rank: 3, topic: "#温予安 语文老师#", tag: "热", readCount: "6.2亿", discussCount: "15萬", comments: [], detailedPosts: [] },
    ...
    observerDiscussion: [
      { id: 'ob1', author: '杜海涛', role: '气氛担当', title: '【震惊】这一季男嘉宾职业太卷了吧！', content: '离婚律师、语文老师、游戏制作人...林柚这要怎么选啊？我都替她纠结！', time: '5分钟前', replies: 340 }
    ],
    fanDiscussions: [
      { id: 'f1', username: '顏值協會會長', content: '陸總好帥！我要爬牆了！', likes: 2300, avatarColor: 'bg-red-400' },
      { id: 'f2', username: '今天嗑糖了嗎', content: '温予安看蘇若畫畫的眼神絕了，好寵溺啊！', likes: 1540, avatarColor: 'bg-indigo-400' },
  ...
  'ep3': {
    hotSearches: [
      ...
      {
        id: 2, rank: 2, topic: "#温予安 这里的雨夜#", tag: "沸", readCount: "12.2亿", discussCount: "45万", comments: [],
        detailedPosts: [
          { id: 'p307', userName: '予若CP粉', userTag: '文艺青年', isVip: true, time: '2分钟前', device: 'iPhone', content: '温予安的雨夜书房！那个"你在我心里的比重，已经让我的世界失衡了"！这是什么神仙告白！文艺又深情！\n\n#予若# #灵魂伴侣#', likes: 8901, comments: 1678, reposts: 678, tags: ['予若'], isHot: true },
          { id: 'p308', userName: '艺术组', userTag: 'CP研究员', isVip: false, time: '4分钟前', device: 'iPad', content: '【深度解读】温予安这段话完美诠释了语文老师和插画师的浪漫！教书需要平衡与耐心，而你成了他的支点！这是什么绝美设定！', likes: 6789, comments: 1234, reposts: 567, tags: ['予若'] },
          ...
          { id: 'p310', userName: '予若守护', userTag: '真爱粉', isVip: false, time: '7分钟前', device: 'iPhone', content: '楼上那位，你不懂艺术家的浪漫就不要乱说！温予安这种深情是发自内心的！予若就是最配的！', likes: 4567, comments: 890, reposts: 345 }
        ]
      },
      {
    ...
    cpRanking: [
      ...
      },
      {
        ...
        observerComment: "温予安这招以退为进很高明。",
        fanComments: ["艺术组上大分！", "细水长流最浪漫！"],
        relatedCharId: 'shen',
        superTopic: {
          title: "予若_灵魂共振", level: "LV9", readCount: "8.5亿", postCount: "5.4万",
          posts: [
            { id: 'cp307', userName: '予若CP粉', userTag: '文艺青年', isVip: true, time: '3分钟前', device: 'iPhone', content: '温予安的雨夜书房！那个"你在我心里的比重，已经让我的世界失衡了"！这是什么神仙告白！文艺又深情！\n\n#予若# #灵魂伴侣#', likes: 8901, comments: 1678, reposts: 678, tags: ['予若'], isHot: true },
            { id: 'cp308', userName: '艺术组', userTag: 'CP研究员', isVip: false, time: '7分钟前', device: 'iPad', content: '【深度解读】温予安这段话完美诠释了语文老师和插画师的浪漫！教书需要平衡与耐心，而你成了他的支点！这是什么绝美设定！', likes: 6789, comments: 1234, reposts: 567, tags: ['予若'] },
            ...
            { id: 'cp310', userName: '予若守护', userTag: '真爱粉', isVip: false, time: '10分钟前', device: 'iPhone', content: '楼上那位，你不懂艺术家的浪漫就不要乱说！温予安这种深情是发自内心的！予若就是最配的！', likes: 4567, comments: 890, reposts: 345 }
          ]
        }
      },
      {
    ...
    observerDiscussion: [
      { id: 'ob1', author: '李雪琴', role: '嗑學家', title: '【尖叫】顧易臣瘋了吧！！', content: '圖書館那個書架咚！那個摘眼鏡！還有那句"我可以不做那個克制的顧易臣了嗎"！救命啊！這是偶像劇都不敢這麼拍的程度！', time: '2分鐘前', replies: 3450 }
    ],
    fanDiscussions: [
      { id: 'f1', username: '陸總的眼鏡', content: '啊啊啊啊啊啊啊啊啊啊啊！（尖叫）', likes: 5000, avatarColor: 'bg-purple-400' },
      { id: 'f2', username: '温予安的畫筆', content: '雨夜书房那一段真的好浪漫，成年人的推拉。', likes: 2800, avatarColor: 'bg-blue-400' },
  ...
  'ep9': {
    hotSearches: [
      ...
      { id: 2, rank: 2, topic: "#林柚到底選誰#", tag: "沸", readCount: "18亿", discussCount: "80萬", comments: [], detailedPosts: [] },
      { id: 3, rank: 3, topic: "#顧易臣 餘生合約#", tag: "热", readCount: "10亿", discussCount: "40萬", comments: [], detailedPosts: [] },
    ...
    fanDiscussions: [
      ...
      { id: 'f3', username: '理智粉', content: '温予安最適合過日子，希望能選温予安。', likes: 6000, avatarColor: 'bg-blue-400' }
    ]
  }
};
...
// 心动回应卡片组件（微博话题讨论模式）
const HeartResponseCard = ({ onConfirm, characterName }: { onConfirm: () => void, characterName: string }) => {
  // 微博讨论数据
  const discussions = useMemo(() => [
    ...
    },
    {
      ...
      username: 'CP粉头子',
      avatar: '💕',
      content: '顾易臣这反应...社恐实锤了！但好想看他破防的样子！',
      time: '1分钟前',
      likes: 2345,
      reposts: 123,
      comments: 156
    ...
    },
    {
      ...
      username: '心动信号粉丝',
      avatar: '📺',
      content: '林柚和顾易臣这对CP我先嗑为敬！表面冷酷内心温暖！',
      time: '3分钟前',
      likes: 4567,
      reposts: 345,
      comments: 389
    },
    {
      ...
      username: '追剧达人',
      avatar: '🎬',
      content: '易臣好贴心！虽然话少但都是实际行动！天哪！这个理由...太戳了！',
      time: '5分钟前',
      likes: 5678,
      reposts: 456,
      comments: 512
    },
    {
      ...
      username: '情感分析师',
      avatar: '💭',
      content: '顾易臣好高冷啊，但莫名有种反差萌！律师职业+温柔内心=绝配！',
      time: '8分钟前',
      likes: 6789,
      reposts: 567,
      comments: 634
  ...
  return (
    <div
      className="fixed inset-0 z-[200] flex flex-col animate-fadeIn overflow-hidden bg-white"
    >
      {/* 微博顶部导航栏 */}
      <div className="h-14 border-b border-gray-200 flex items-center justify-between px-4 bg-white sticky top-0 z-20 shadow-sm">
        <div className="flex items-center gap-4">
          <button onClick={onConfirm} className="text-gray-600 hover:text-gray-900 transition-colors">
            <ArrowLeft size={24} />
          </button>
          <span className="text-lg font-semibold text-gray-900">话题讨论</span>
        </div>
      ...
      {/* 话题标签区域 */}
      <div className="bg-gradient-to-r from-pink-50 to-purple-50 border-b border-gray-200 px-4 py-6">
        <div className="flex items-center gap-3 mb-2">
          <Hash size={20} className="text-pink-500" />
          <h1 className="text-2xl font-bold text-gray-900">心动回应</h1>
        </div>
        <p className="text-sm text-gray-600 ml-8">你对 {characterName} 产生了初步的心动信号！</p>
        <div className="mt-3 flex items-center gap-4 ml-8">
          <span className="text-sm text-gray-500">阅读 12.3万</span>
          <span className="text-sm text-gray-500">讨论 {discussions.length}</span>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto bg-white">
        {discussions.map((discussion) => (
          <div key={discussion.id} className="border-b border-gray-100 px-4 py-4 hover:bg-gray-50 transition-colors">
            <div className="flex gap-3">
              {/* 头像 */}
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-200 to-purple-200 flex items-center justify-center text-xl flex-shrink-0">
                {discussion.avatar}
              </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-semibold text-gray-900 text-sm">{discussion.username}</span>
                  <span className="text-xs text-gray-500">{discussion.time}</span>
                </div>

                {/* 讨论内容 */}
                <p className="text-gray-900 text-sm leading-relaxed mb-3">{discussion.content}</p>
                ...
                <div className="flex items-center gap-6 text-gray-500">
                  ...
                  <button className="flex items-center gap-1 hover:text-green-500 transition-colors">
                    <RotateCcw size={16} />
                    <span className="text-xs">{discussion.reposts}</span>
                  </button>
        ...
        <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-xl p-4 text-white shadow-lg">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <Sparkles size={20} />
              <span className="font-bold text-sm">查看心动信号</span>
            </div>
            <ChevronRight size={20} />
          </div>
          <p className="text-xs text-white/90 mb-3">点击下方信号按钮，查看更多互动细节</p>
          <button
            onClick={onConfirm}
            className="w-full bg-white text-pink-600 py-2 rounded-lg font-bold text-sm hover:bg-pink-50 transition-colors active:scale-98"
          >
            前往信号界面
          </button>
        </div>
...
// EP02 主题卡片组件（3D效果）
const Episode2ThemeCard = ({ onConfirm }: { onConfirm: () => void }) => {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const offsetX = e.clientX - dimensions.centerX;
      const offsetY = e.clientY - dimensions.centerY;

      const rotateX = ((offsetY / (dimensions.height / 2)) * -8).toFixed(2);
      const rotateY = ((offsetX / (dimensions.width / 2)) * 8).toFixed(2);

      cardRef.current.style.transform = `rotateX(${rotateX}deg) rotateY(${rotateY}deg)`;

      highlightRef.current.style.opacity = '1';
      const moveX = (offsetX / dimensions.width) * 100;
      const moveY = (offsetY / dimensions.height) * 100;
      highlightRef.current.style.background = `radial-gradient(circle at ${50 + moveX}% ${50 + moveY}%, rgba(255,255,255,0.2), transparent 70%)`;
    };
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center animate-fadeIn overflow-hidden" style={{
      background: `
        linear-gradient(180deg, #120024 0%, #220033 30%, #1a0028 60%, #0a0a20 100%)
      `,
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[20%] w-[300px] h-[300px] bg-purple-600/40 rounded-full blur-[100px] animate-pulse"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-pink-600/30 rounded-full blur-[120px]" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-[40%] left-[-10%] w-[200px] h-[200px] bg-indigo-600/30 rounded-full blur-[80px]" style={{ animationDelay: '4s' }}></div>
      </div>
        ...
        {particles.map((particle) => (
          <div
            ...
            style={{
              ...
              background: `radial-gradient(circle, rgba(236, 72, 153, 0.6) 0%, rgba(168, 85, 247, 0.4) 50%, transparent 100%)`,
              boxShadow: `0 0 ${particle.size * 2}px rgba(236, 72, 153, 0.5)`,
              animation: `ep2-particle-float ${particle.duration}s ease-in-out infinite`,
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Ma+Shan+Zheng&family=Long+Cang&display=swap');
        ...
        .ep2-card {
          ...
          box-shadow: 
            ...
            0 15px 35px rgba(62, 39, 35, 0.2),
            0 25px 50px rgba(62, 39, 35, 0.15),
            0 40px 80px rgba(62, 39, 35, 0.1),
            inset 0 0 30px rgba(0,0,0,0.08),
            inset -15px 0 25px rgba(0,0,0,0.06),
            inset 15px 0 25px rgba(255,255,255,0.1),
            inset 0 -15px 25px rgba(0,0,0,0.05),
            inset 0 15px 25px rgba(255,255,255,0.08),
            inset -8px -8px 15px rgba(0,0,0,0.04),
        ...
        .ep2-card::after {
          ...
          height: 100%;
          background: 
            radial-gradient(ellipse 150px 80px at 25% 35%, rgba(0,0,0,0.08) 0%, transparent 60%),
            radial-gradient(ellipse 120px 100px at 75% 65%, rgba(0,0,0,0.06) 0%, transparent 60%),
            radial-gradient(ellipse 100px 120px at 50% 20%, rgba(0,0,0,0.05) 0%, transparent 50%),
            radial-gradient(ellipse 80px 90px at 15% 80%, rgba(0,0,0,0.04) 0%, transparent 50%),
            radial-gradient(ellipse 90px 110px at 85% 25%, rgba(0,0,0,0.05) 0%, transparent 50%);
          box-shadow: 
            inset 0 0 60px rgba(93, 64, 55, 0.15),
            inset -12px 0 30px rgba(0,0,0,0.08),
            inset 12px 0 30px rgba(255,255,255,0.12),
            inset 0 -12px 30px rgba(0,0,0,0.07),
        ...
        .ep2-fold-marks {
          ...
          z-index: 2;
          background: 
            linear-gradient(to bottom, transparent 29%, rgba(0,0,0,0.06) 30%, rgba(255,255,255,0.4) 30.5%, rgba(0,0,0,0.03) 31%, transparent 32%),
            linear-gradient(to bottom, transparent 59.5%, rgba(0,0,0,0.12) 60%, rgba(255,255,255,0.6) 60.5%, rgba(0,0,0,0.05) 61%, transparent 62%),
            linear-gradient(to right, transparent 39.5%, rgba(0,0,0,0.08) 40%, rgba(255,255,255,0.5) 40.5%, rgba(0,0,0,0.04) 41%, transparent 42%);
          mix-blend-mode: multiply;
        }
        ...
        .ep2-fold-highlight {
          ...
          z-index: 2;
          background: 
            linear-gradient(to bottom, transparent 59.5%, rgba(255,255,255,0.4) 60%, rgba(255,255,255,0.7) 60.5%, rgba(255,255,255,0.4) 61%, transparent 61.5%),
            linear-gradient(to right, transparent 39.5%, rgba(255,255,255,0.35) 40%, rgba(255,255,255,0.6) 40.5%, rgba(255,255,255,0.35) 41%, transparent 41.5%);
        ...
        .ep2-title {
          ...
          font-weight: 400;
          margin: 0;
          text-shadow: 0 0 2px rgba(93, 64, 55, 0.3), 1px 1px 0px rgba(93, 64,55,0.1);
          opacity: 0;
          transform: scale(1.1);
          filter: blur(4px);
          animation: ep2-dryInkIn 1.8s cubic-bezier(0.22, 1, 0.36, 1) forwards;
        ...
        .ep2-subtitle {
          ...
          padding: 8px 12px;
          opacity: 0;
          animation: ep2-simpleFadeIn 2s ease forwards;
        ...
        @keyframes ep2-dryInkIn {
          to { opacity: 1; transform: scale(1); filter: blur(0px); }
        }

        @keyframes ep2-simpleFadeIn {
          to { opacity: 0.8; }
        }

        @keyframes ep2-particle-float {
          0% { transform: translate(0, 0) scale(1); opacity: 0.8; }
          25% { transform: translate(20px, -30px) scale(1.2); opacity: 1; }
          50% { transform: translate(-15px, -60px) scale(0.9); opacity: 0.6; }
          75% { transform: translate(25px, -90px) scale(1.1); opacity: 0.4; }
          100% { transform: translate(10px, -120px) scale(0.8); opacity: 0; }
        }
      `}</style>

      <div className="ep2-card-container" onClick={(e) => e.stopPropagation()}>
        <div className="ep2-card" ref={cardRef}>
          <div className="ep2-fold-marks"></div>
          <div className="ep2-fold-highlight"></div>
          <div className="ep2-highlight-layer" ref={highlightRef}></div>

          <div className="ep2-content">
            <h1 className="ep2-title">
              我们都在用<br />
              <span style={{ fontSize: '1.1em', color: '#3e2723', display: 'inline-block', transform: 'rotate(-1deg)' }}>工作的方式</span><br />
              谈恋爱
            </h1>

            <div className="ep2-subtitle">Season 1 · 观察日记</div>

            <div className="ep2-stamp">存档</div>
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${scenario.rarity === 'SSR' ? 'bg-yellow-500 text-black' :
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          ...
          className={`w-full h-full object-cover ${option?.id === 'opt-lu-ep1' ? 'opacity-60' : 'opacity-30'
            }`}
          style={option?.id === 'opt-lu-ep1' ? { filter: 'brightness(1.2)' } : {}}
          alt="背景"
        />
        <div
          className={`absolute inset-0 bg-gradient-to-t ${option?.id === 'opt-lu-ep1'
      ...
      {/* 人物立绘区域 */}
      <div className="relative flex-1 flex items-end justify-center pb-40">
        {currentCharacter && currentDialogue?.speaker !== 'narrator' && (
          <div className="relative max-w-md w-full mx-auto animate-fadeIn">
            ...
            />
            {/* 名字标签 - 已移除，因为现在在对话框右上角显示 */}
          </div>
        )}
      </div>

      {/* 对话框区域 - 调整位置和布局 */}
      <div className="relative bottom-24 left-0 right-0 p-4 pb-8 animate-slideUp">
        <div className="max-w-6xl mx-auto">
          {/* 对话内容 */}
          <div className="bg-black/80 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl relative min-h-[120px] flex items-center">
            {/* 说话者名字标签 - 右上角 */}
            {currentDialogue && currentDialogue.speaker !== 'narrator' && (
              <div className="absolute -top-3 right-4 z-10">
                <div className="bg-gradient-to-r from-pink-500 to-purple-600 px-4 py-2 rounded-lg whitespace-nowrap shadow-lg">
            ...
            <p className="text-white text-lg leading-relaxed font-light flex-1 pt-2">
              ...
              {scenario.options.map(opt => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl border transition-all flex items-center gap-4 group active:scale-[0.98] ${isOptionCompleted
                  ...
                  >
                    <div className={`w-12 h-12 rounded-full overflow-hidden flex-shrink-0 border-2 transition-colors ${isOptionCompleted
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {chat.messages.map(msg => (
          <div key={msg.id} className={`flex ${msg.senderId === 'me' ? 'justify-end' : 'justify-start'} animate-fadeIn`}>
            ...
            <div className={`max-w-[70%] px-3 py-2 rounded-xl text-sm shadow-md leading-relaxed border ${msg.senderId === 'me' ? 'bg-pink-600 text-white border-pink-500' : 'bg-white/10 text-white border-white/10 backdrop-blur-sm'
              }`}>
          ...
          {ENDINGS.map(end => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-4 p-4 rounded-2xl border transition-all group text-left relative overflow-hidden ${isAvailable
...
const generateSocialPosts = (charId: string): SocialPost[] => {
  ...
  const captions = {
    ...
    'shen': ['教学日常', '午后时光', '生活中的美', '批改作业', '简单生活', '分享瞬间'],
      ...
      <div className="flex-1 overflow-y-auto bg-white">
        ...
        <div className="flex border-t border-gray-300">
          ...
          <button
            ...
            className={`flex-1 py-3 flex items-center justify-center gap-2 border-b-2 transition-colors ${activeTab === 'tagged'
              ? 'border-black text-black'
              : 'border-transparent text-gray-400'
              }`}
          >
                ...
                >
                  ...
                  <div className="relative z-10 flex-1 text-left">
                    <h4 className="font-bold text-white text-lg mb-1 group-hover:text-pink-200 transition-colors">
                      {opt.id === 'opt-lu-ep1' ? '顾易臣' : opt.id === 'opt-shen-ep1' ? '温予安' : opt.id === 'opt-jiang-ep1' ? '江烈' : opt.label}
                    </h4>
...
export default function LoveSignalSim() {
  ...
  const [currentScenarioIdx, setCurrentScenarioIdx] = useState(4); // 直接解锁第五章 (ep5)
  ...
  // 心动回应卡片显示状态（用于 ep1 选择顾易臣后）
  const [showHeartResponseCard, setShowHeartResponseCard] = useState(false);
  const [heartResponseCharacter, setHeartResponseCharacter] = useState<string>('');
  const [pendingDecisionOption, setPendingDecisionOption] = useState<StoryOption | null>(null);

  // EP02 主题卡片显示状态
  const [showEpisode2ThemeCard, setShowEpisode2ThemeCard] = useState(false);
  const [pendingEpisode2Option, setPendingEpisode2Option] = useState<StoryOption | null>(null);

  // 处理心动回应卡片关闭
  const handleHeartResponseCardClose = () => {
    setShowHeartResponseCard(false);
    // 如果有待处理的决策选项，直接标记为已完成，不显示故事内容
    if (pendingDecisionOption) {
      const completedOptionId = pendingDecisionOption.id;
      setCompletedOptions(prev => {
        const newSet = new Set(prev);
        newSet.add(completedOptionId);
        return newSet;
      });
      setPendingDecisionOption(null);
    }
  };
  ...
  const handleOptionClick = (id: string) => {
    ...
    if (opt) {
      // 如果是支线剧情选项（有dialogues数组），直接显示对话，不显示决策卡片
      if (opt.dialogues && opt.dialogues.length > 0) {
        setExpandedScenario(null); // Close the detail modal when option selected
        handleStartStory(opt);
        return;
      }
  ...
  const handleStartStory = (option: StoryOption) => {
    ...
    // 如果是 ep2，先显示主题卡片
    if (scenario.id === 'ep2') {
      setPendingEpisode2Option(option);
      setShowEpisode2ThemeCard(true);
      return;
    }
  ...
  // 处理EP02主题卡片关闭
  const handleEpisode2ThemeCardClose = () => {
    setShowEpisode2ThemeCard(false);
    if (pendingEpisode2Option) {
      const scenario = expandedScenario || currentScenario;
      setFullScreenStory({ scenario, option: pendingEpisode2Option });
      setPendingEpisode2Option(null);
    }
  };
  ...
  const handleDecision = (type: 'stay' | 'leave' | 'think') => {
    ...
    setDecisionOption(null);
    if (type === 'stay') {
      // 如果是 ep1 且回应了顾易臣，先显示心动回应卡片
      if (currentScenario.id === 'ep1' && charName === '顾易臣') {
        setHeartResponseCharacter('顾易臣');
        setPendingDecisionOption(decisionOption); // 保存决策选项
        setShowHeartResponseCard(true);
        // 不立即显示故事，等待心动回应卡片关闭
        return;
      }
      ...
      if (currentScenario.id === 'ep1' && (charName === '顾易臣' || charName === '温予安' || charName === '江烈')) {
        ...
        if (charName === '顾易臣') {
          ...
          innerThoughts = [
            ...
            {
              speaker: '温予安',
              text: '（推了推眼鏡）顧易臣...一如既往地先發制人。',
              characterId: 'shen',
              emotion: 'normal'
            },
            {
              speaker: 'narrator',
              text: '温予安的目光在空蕩的門口停留了兩秒，指尖無意識地敲擊著沙發扶手。'
            },
            {
              speaker: '温予安',
        ...
        } else if (charName === '温予安') {
          // 回应温予安后，显示顾易臣和江烈的内心状态
          innerThoughtsId = 'inner-thoughts-ep1-shen';
          innerThoughtsTitle = '內心獨白 · 觀察者的注視';
          innerThoughtsDesc = '顧易臣與江烈的內心獨白';
          ...
          innerThoughts = [
            ...
            {
              speaker: 'narrator',
              text: '顧易臣放下手中的文件，鏡片後的目光追隨著你們的背影，嘴角勾起一抹難以察覺的弧度。'
            },
            {
              speaker: '顾易臣',
              text: '（低語）温予安...還是那麼謹慎。',
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-900 font-sans selection:bg-pink-200">
      <div className="w-full max-w-[430px] h-[100vh] sm:h-[850px] bg-black/30 sm:rounded-[3rem] sm:border-[8px] sm:border-gray-800 sm:shadow-2xl relative overflow-hidden flex flex-col ring-1 ring-white/10 backdrop-blur-3xl">
                ...
                >
                  {SCENARIOS.map((scenario, idx) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`absolute top-3 left-3 z-20 px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider ${isCompleted ? 'bg-green-500 text-black' : isCurrent ? 'bg-red-500 text-white animate-pulse' : 'bg-gray-700 text-gray-400'
                          }`}>
                ...
                <div className="space-y-3">
                  {socialData.hotSearches.map((item, i) => (
                    <div key={item.id} onClick={() => setSelectedTopic({ title: item.topic, readCount: item.readCount, discussCount: item.discussCount, posts: item.detailedPosts || [] })} className="flex items-center justify-between group cursor-pointer hover:bg-white/10 p-2 rounded-lg transition-colors border border-transparent hover:border-white/10">
                      <div className="flex items-center gap-3">
                        {i < 3 ? (
                          <div className={`w-5 h-5 flex items-center justify-center rounded-md font-black text-xs ${i === 0 ? "bg-gradient-to-br from-yellow-300 to-yellow-600 text-black shadow-yellow-500/50" :
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-[9px] px-1.5 py-0.5 rounded text-white font-bold shadow-sm ${item.tag === '爆' ? 'bg-gradient-to-r from-red-600 to-red-500' :
                  ...
                  {dynamicCpRanking.map((cp, i) => (
                    <div key={cp.id} className="flex flex-col bg-white/5 rounded-xl overflow-hidden border border-white/10 hover:border-pink-500/50 transition-all hover:bg-white/10 group">
                      <div className="flex items-center justify-between p-3 cursor-pointer" onClick={() => setExpandedCpId(expandedCpId === cp.id ? null : cp.id)}>
                        ...
                        <div className="flex items-center gap-2">
                          <div className={`text-[9px] font-bold flex items-center gap-0.5 ${cp.trend === 'up' ? 'text-red-400' :
        ...
        {/* Modals & Overlays */}
        {showHeartResponseCard && (
          <HeartResponseCard
            onConfirm={handleHeartResponseCardClose}
            characterName={heartResponseCharacter}
          />
        )}

        {showEpisode2ThemeCard && (
          <Episode2ThemeCard onConfirm={handleEpisode2ThemeCardClose} />
        )}
      ...
      <style>{`
        ...
        .animate-danmaku { animation: danmaku linear forwards; }
